...
addToCode = (char) ->
    ...
    codeLayer.html = "<h1 style='padding: 30px; white-space: normal; word-wrap: break-word; line-height: 65px'>" + codeLayer.customData.text + "</h1>"
...
console.log keyboardLayer.x, keyboardLayer.y
